    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="row clearfix" style="padding-top:30px">
                <div class="col-sm-6">
                    <h4 style="font-size:25px !important"> Designation Edit </h4>
                </div>
            ...
            <form action="{{ route('admin.designations.update', $designation->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="input-group @error('name') has-error @enderror" style="width: 100%; margin-bottom:12px">
                    ...
                    <input type="text" class="form-control" name="name" value="{{ old('name') ?: $designation->name }}" placeholder="Designation Name">
                </div>
                @error('name')
