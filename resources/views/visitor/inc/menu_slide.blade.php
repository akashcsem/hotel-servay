<div id="demo-1" data-zs-src='["{{asset('frontEnd')}}/images/4.jpg", "{{asset('frontEnd')}}/images/2.jpg", "{{asset('frontEnd')}}/images/1.jpg","{{asset('frontEnd')}}/images/3.jpg"]' data-zs-overlay="dots">
    <div class="demo-inner-content">
        ...
        <div class="header-w3-agileits" id="home">
            ...
            <div class="baner-info">
                ...
                <h4>Book Your Dream Hotel Rooms</h4>
